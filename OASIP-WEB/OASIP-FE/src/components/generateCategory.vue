    ...
    <ol class="items-center sm:flex  ">
      <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
          <div class="flex z-10 justify-center items-center w-6 h-6 bg-blue-300 rounded-full ring-0 ring-gray-200 dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">

            <svg xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--material-symbols" width="15" height="15" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
              <path fill="#000" d="M17.825 9L15 6.175l1.4-1.425l1.425 1.425l3.525-3.55l1.425 1.425ZM5 21V5q0-.825.588-1.413Q6.175 3 7 3h6v2H7v12.95l5-2.15l5 2.15V11h2v10l-7-3ZM7 5h6h-1Z">
              </path>
            </svg>
          </div>
        ...
        <div class="mt-3 sm:pr-8">
          <h3 class="text-lg font-semibold text-gray-500 dark:text-white">select category</h3>
        </div>
      </li>
      ...
      <li class="relative mb-6 sm:mb-0">
        ...
        <div class="mt-3 sm:pr-8">
          <h3 class="text-lg font-semibold text-gray-500 dark:text-white">enter information</h3>
        </div>
      </li>
      ...
      <li class="relative mb-6 sm:mb-0">
        <div class="flex items-center">
          <div class="flex z-10 justify-center items-center w-6 h-6 bg-blue-300 rounded-full ring-0 ring-gray-200 dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--icon-park-outline" width="15" height="15" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48">
              <g fill="none">
                <g stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" clip-path="url(#IconifyId180e2ff12bc36151318)">
        ...
        <div class="mt-3 sm:pr-8">
          <h3 class="text-lg font-semibold text-gray-500 dark:text-white">submit a form</h3>
        </div>
      </li>
    </ol>
  ...
  <div class="grid grid-cols-3 gap-6 place-items-center mb-12" v-if="askShowList">
    <div v-for="category in categorys" :key="category.eventCategoryID">
      <div class="grid justify-items-center">
        ...
        <button @click="ShowDetailCate(category.eventDuration, category.eventCategoryDescription, category.eventCategoryID, category.eventCategoryName)" class="transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-150 rounded-lg text-sm leading-6  font-semibold select-none text-sky-600 ">
              show detail </button>
        <br>
